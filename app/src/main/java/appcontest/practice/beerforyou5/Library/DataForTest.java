...
public class DataForTest{
    ...
    public static String[] name_for_image = {
            "APPOR rted ",
            "Hoegaarden ",
            "n R m ",
            "GUINNESS DRAUGHT ",
    ...
    public static Integer[] images = {
            ...
            R.drawable.kozeldark,//// kozel darkTODO: 2015-11-25
            R.drawable.pilsnerurquell,
            R.drawable.miller,
            R.drawable.becks,
            R.drawable.lweizen,// // L weizenTODO: 2015-11-25
        ...
        public static int findItemPositionByImage(String text){
                int itemPosition=0;
                int numBeer = name_for_image.length;
                int[] editDistance = new int[numBeer];
                int minEditDistance;
                //text = text.toLowerCase();
                editDistance[0] = minDistance(text, name_for_image[0] );
                minEditDistance = editDistance[0];
                for(int i =1; i<numBeer; i++){
                        editDistance[i] = minDistance(text, name_for_image[i] );
