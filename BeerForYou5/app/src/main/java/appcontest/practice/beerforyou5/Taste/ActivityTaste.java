 ...
 */
public class ActivityTaste extends FragmentActivity implements
        ActionBar.TabListener, TabTaste1.OnTabTaste1WordSelectedListener,
        TabTaste2.OnTabTaste2WordSelectedListener, TabTaste3.OnTabTaste3WordSelectedListener,
        TabTaste4.OnTabTaste4WordSelectedListener, TabTaste5.OnTabTaste5WordSelectedListener
{
    ...
    public void onResume() {
        super.onResume();
        Log.d("ActivityTaste", "On Resume ");
        // getting information of user rating when ActivityTaste resume
    ...
    public void onTabTaste1WordSelected(int position) {
        ...
        Intent intent = new Intent(ActivityTaste.this, appcontest.practice.beerforyou5.InfoActivity.class);
    ...
    public void onTabTaste3WordSelected(int position) {
        Log.i("Main Activity", " Method : onWordSelected ");
        Intent intent = new Intent(ActivityTaste.this, appcontest.practice.beerforyou5.InfoActivity.class);
        intent.putExtra("ARG_POSITION", String.valueOf(position));
        startActivityForResult(intent, GET_STRING);
    }
    public void onTabTaste4WordSelected(int position) {
        Log.i("Main Activity", " Method : onWordSelected ");
        Intent intent = new Intent(ActivityTaste.this, appcontest.practice.beerforyou5.InfoActivity.class);
        intent.putExtra("ARG_POSITION", String.valueOf(position));
        startActivityForResult(intent, GET_STRING);
    }
    public void onTabTaste5WordSelected(int position) {
        Log.i("Main Activity", " Method : onWordSelected ");
        Intent intent = new Intent(ActivityTaste.this, appcontest.practice.beerforyou5.InfoActivity.class);
        intent.putExtra("ARG_POSITION", String.valueOf(position));
        startActivityForResult(intent, GET_STRING);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position) {
                case 0:
                    return new TabTaste1(mContext);
                case 1:
                    return new TabTaste2(mContext);
                case 2:
                    return new TabTaste3(mContext);
                case 3:
                    return new TabTaste4(mContext);
                case 4:
                    return new TabTaste5(mContext);
            }
            return null;
        }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                case 0:
                    return getString(R.string.taste_title_section1);
                case 1:
                    return getString(R.string.taste_title_section2);
                case 2:
                    return getString(R.string.taste_title_section3);
                case 3:
                    return getString(R.string.taste_title_section4);
                case 4:
                    return getString(R.string.taste_title_section5);
            }
            return null;
        }
    }
